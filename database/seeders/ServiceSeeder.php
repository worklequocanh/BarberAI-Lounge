    ...
    public function run(): void
    {
        ...
        $services = [
            ...
            [
                ...
                'combo_items' => ['Cắt tóc tiêu chuẩn', 'Gội đầu dưỡng sinh', 'Cạo râu khăn nóng'],
                'duration_min' => 50,
                'is_active' => true,
            ],
            [
                'category_id' => $catCombo?->id,
                'name' => 'Combo Uốn Idol Hàn Quốc (Chuẩn Form Side Part/Two Block)',
                'slug' => 'combo-uon-idol-han-quoc',
                'description' => 'Trọn gói Cắt Fade tạo phom + Uốn Textured/Down Perm + Gội massage xịt dưỡng.',
                'price' => 299000,
                'is_combo' => true,
                'original_price' => 380000,
                'combo_items' => ['Cắt fade nghệ thuật', 'Uốn tóc tạo kiểu', 'Gội dưỡng sinh'],
                'duration_min' => 75,
                'is_active' => true,
            ],
            [
                'category_id' => $catCombo?->id,
                'name' => 'Combo Nhuộm Tẩy Khói Sáng Fashion King',
                'slug' => 'combo-nhuom-tay-khoi-fashion-king',
                'description' => 'Cắt tạo phom Mullet/Crop + Tẩy Olaplex + Nhuộm màu khói xám thời thượng.',
                'price' => 499000,
                'is_combo' => true,
                'original_price' => 650000,
                'combo_items' => ['Cắt fade nghệ thuật', 'Tẩy tóc Olaplex', 'Nhuộm thời trang'],
                'duration_min' => 120,
                'is_active' => true,
            ],
            [
                ...
                'combo_items' => ['Cắt fade nghệ thuật', 'Uốn tóc tạo kiểu', 'Chăm sóc râu', 'Gội dưỡng sinh'],
                'duration_min' => 100,
                'is_active' => true,
            ],
        ];
